...
//	static String pathToStopword = "/Users/fabiopalomba/Documents/PhD/Papers/Working/Antipatterns/fse17-socialSmells/stopword";
	static String pathToStopword = "StopWords.txt";
		...
		// C3 metric for all the classes in a component
		public static double getC3Module(ModuleBean mb) {
			Double c3=0.0;
			double comparisons=0.0;
			CosineSimilarity cosineSimilarity = new CosineSimilarity(ConceptualMetrics.pathToStopword);

			for(ClassBean cb: mb.getClasses()) {
	        ...
	        c3=c3/comparisons; //average conceptual similarity of classes in the module
	...
	public static double getC3(ClassBean cb) {
		...
		c3=c3/comparisons; //average conceptual similarity of methods in the class

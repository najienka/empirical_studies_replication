...
import metricsTool.beans.InstanceVariableBean;
import metricsTool.beans.MethodBean;

public class MethodParser {
	
	public static MethodBean parse(MethodDeclaration pMethodNode, Collection<InstanceVariableBean> 
			pClassInstanceVariableBeans, Collection<MethodDeclaration> pMethodDeclarations,
		...
		for (String invocation : invocations){
			invocationBeans.add(InvocationParser.parse(invocation, pMethodDeclarations, pBelongingClassName));
		}
